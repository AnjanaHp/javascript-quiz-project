document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    ...
    new Question(
      ...
      ["Compares only values", "Assigns a value to a variable", "Compares values and types", "None of the above"],
    ...
    new Question(
      "What of the following array methods adds a new element to the beginning of an array?",
      ["push()", "unshift()", "pop()", "shift()"],
      "unshift()",
      2
    ), new Question(
      "What is the correct way to access a property named age in an object user?",
      ["user(age)", "user.age", "user=>name", "user:name"],
      "user(age)",
      2
    ), new Question(
      "What is the value of X? let x =5; x +=3;",
      ["5", "3", "8", "undefined"],
      "8",
      3
    ), new Question(
      "What will be the output of this code? console.log( 0 == false) ; console.log( 0 === false)",
